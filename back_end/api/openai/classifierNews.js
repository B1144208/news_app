...
【中英雙語關鍵字規則】
- 若某個關鍵字是「英文」單字或片語（主要由 A–Z 組成），同時在陣列中加入對應的「繁體中文」翻譯作為另一個元素。
  - 例如：若你選出 "apple"，請在同一個陣列中再加入 "蘋果"，結果可以是：
    ["apple","蘋果", ...]
  - 若是 "United States"，可同時輸出：
    ["United States","美國", ...]
- 中文翻譯要自然、常見，不要生造奇怪的譯名。
- 如果某些專有名詞「沒有明確、普遍使用的中文譯名」，就只保留英文關鍵字，不強行翻譯。
